({
            ...
            function(response) {
                ...
                if (response.isOfferListVisible) {
                    ...
                    for (let i = 0; i < offerList.length; i++) {
                        ...
                        } else if (offerList[i].Source_of_Payment__c != 'PSA' && offerList[i].Tradeline_Litigation_Status__c != 'Non Lit') {
    ...
    getMoreInfo : function(component, event, helper) {
        ...
        console.log('**** indexPos-->', indexPos);
        let tasksToDisplay = component.get("v.tasksToDisplay") || [];
        console.log('**** tasksToDisplay-->', tasksToDisplay[indexPos]);
        helper.callServerMethod(
            component,
            helper,
            "getViewInfo",
            ...
            function(response){
                if (response) {
                    ...
                    component.set("v.taskInfo", response);
                    component.set("v.isModalOpen", true);
                    console.log('taskInfo--->',component.get("v.taskInfo"));
                }
            },
            null 
        );
