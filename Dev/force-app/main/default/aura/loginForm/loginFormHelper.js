({
    ...
    handleLogin: function (component, event, helpler, isReset, oneSignalInfo) {
        /*
         * Issue in getting the Domain URL so we cannot get the record 
        let domain = window.location.origin;
        //uncommented by Haarati 
        let pathName = window.location.pathname.split('/s');
        ...
        if (navigator.userAgent.indexOf('gonative') > -1) {   
            ...
            urlEvent.setParams({
                "url": "gonative://auth/status?callbackFunction=gonative_status_beforelogin"
            });
            /*urlEvent.setParams({
                "url": "gonative://open/app-settings"
            });*/
            urlEvent.fire();  
            return;
        }        
        ...
        /*let loggedInIp;
        helpler.getLoggedInuserIp(function(ip) {
            console.log('**** ip');
            loggedInIp = ip;
        }); */
        ...
        console.log('***** usernamelist-->', usernamelist.includes(username));
